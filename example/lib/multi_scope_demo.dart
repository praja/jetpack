      ...
      body: Column(
        children: [
          const Padding(
            ...
            child: Text('Here are multiple counters in different scopes, reacting independently, because they have their own ViewModel in each of their scopes')
          ),
          Center(
            child: Scope(
          ...
          const Padding(
              padding: EdgeInsets.all(16),
              child: Text('Go Back to see the counter state of the previous page still intact. \n\nAnd come back to this page by clicking NEXT to see the counter state lost. Scope gets disposed when it is removed from the stack')
          ),
          ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ViewModelKeyDemo()));
              },
